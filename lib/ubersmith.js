...
var cache_redis = {};
var cache_multi = {};
var cache_memory = cache_manager.caching({store: 'memory', max: 2048 /*Bytes*/, ttl: 5 /*seconds*/});
var cache_primary = cache_memory;
var disableRedisStore = false;
var defaultExpiration = 30;
      ...
      async.waterfall([
        ...
        function(redisResponse, waterfallCallback) {
          if (redisResponse != 'MISS')
          {
            ...
            if (!(translationTable.ubersmith && translationTable.ubersmith.method && translationTable.ubersmith.params && translationTable.ubersmith.key)) {
              logger.log('error', 'failed to get item from ubersmith', {})
