...
// from Redis and Ubersmith
  ...
  UberettaStone['comments']['attachment'] = {
    ...
    ubersmith: { method: 'uber.attachment_get', params: '&attach_type=comment&attach_id=%token%', key: 'uber.comment_list'}
  }

  UberettaStone['comments']['attachments'] = {
    redis: { key: 'clients:comments:attachments:%token%', method: 'smembers'},
    ubersmith: { method: 'uber.attachment_list', params: '&attach_type=comment', key: 'uber.comment_list'}
  }
